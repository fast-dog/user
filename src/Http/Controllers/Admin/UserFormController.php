...
use FastDog\User\Http\Request\AddUser;
use Carbon\Carbon;
...
class UserFormController extends Controller implements FormControllerInterface
{
     ...
     */
    protected function postUserDelete(Request $request): JsonResponse
    {
        $result = ['success' => true];
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function postUser(AddUser $request): JsonResponse
    {
        $result = [
            'success' => true,
        ];
        ...
        $data = [
            ...
            User::DATA => json_encode($request->input('data', []))
        ];
